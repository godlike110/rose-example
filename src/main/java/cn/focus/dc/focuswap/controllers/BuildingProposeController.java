...
public class BuildingProposeController {
    ...
    public String getDaoGou(Invocation inv, Device device, @Param("cityName") @DefValue("bj") String cityName,
            ...
            if(bp != null){
                ...
                //对参数做encode
                String enTitle = URLEncoder.encode(bp.getPromotion(),"UTF-8");
                String enPic = URLEncoder.encode(bp.getPic(),"UTF-8");
                String enUrl = URLEncoder.encode(inv.getRequest().getRequestURL().toString(),"UTF-8");
                //md5加密
                StringBuffer md5 = new StringBuffer();
                md5.append("&pic=").append(bp.getPic()).append("&title=").append(bp.getPromotion()).append("&url=")
                ...
                .append(bp.getId()).append("&cType=1")
