...
public class MapAndArroundController {
    ...
    public String mapAndArround(Device device, Invocation inv,
        ...
        if (buildingName.length() >= 5 && WapVersion.valueOf("PHONE") == deviceWap) {
        ...
        if (WapVersion.valueOf("PHONE") == deviceWap) {
            // phone展示页
