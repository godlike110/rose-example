...
<html lang="en">
	...
	<body>
				...
				<header class="clearfix">
					...
					<div class="menu menu_right fr" id="menu">
						...
						<div class="menu_list">
							...
							<a href="${ctx }/${_city.cityPinyinAbbr }/baodian/" role="touch_bg" class="current">宝典</a>
						</div>
					</div>
				</header>
				...
				<section class="content clearfix">
					<article class="no_padd">
						<ul class="article_list article_img article_img2 article_line p20">
							...
							<li role="touch_bg">
								<a href="${ctx }/${_city.cityPinyinAbbr }/baodian/${housingGuide.id}/" class="clearfix">
									<img src="${housingGuide.picUrl}" alt="${housingGuide.title }" class="img fl" />
									<dl>
										<dt>${housingGuide.title }</dt>
										<c:if test="${not empty housingGuide.summary  }">
											<dd>${housingGuide.summary }</dd>
										</c:if>
										<dd class="seprate">${housingGuide.catagoryName }
										<span>
		...
		<script src="http://192.168.242.44/sceapp/focus_static/wap/pad/snippets/sohu.focus.mobile.baodian.gh_1.0.js"></script>
