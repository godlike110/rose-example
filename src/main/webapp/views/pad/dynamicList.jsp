...
<html lang="en">
	...
	<body class="bg_all layout_fixed">
			...
			<div class="scroller">
				...
				<section class="content clearfix">
					<article class="art_text">
						<ul class="article_list article_line dynamic_mod">
							...
							<li role="touch_bg" href="${ctx }/${_city.cityPinyinAbbr }/loupan/${building.groupId}/dongtai/${rw.infoid}/">
								<a href="javascript:;">
									<dl>
										<dt class="clearfix">${rw.infoname }<span class="fr">${rw.infotime }</span></dt>
				...
				<section class="crumb">
					<div class="inner">
						...
						<a href="${ctx }/${_city.cityPinyinAbbr }/loupan/${building.groupId}/">${building.projName }</a>&gt;
						<span>楼盘动态</span>
					</div>
		...
		<footer class="position_fixed">		
				<a href="tel:4008882200,${building.phone400}" class="free_advice"><b></b>免费咨询 400-888-2200 转 ${building.phone400}</a>
		</footer>
		</c:if>
		<c:if test="${building.phone400==0 }">
			<footer class="position_fixed">
		...
		<script src="http://192.168.242.44/sceapp/focus_static/wap/pad/snippets/sohu.focus.mobile.dynamic.gh_1.0.js"></script>
