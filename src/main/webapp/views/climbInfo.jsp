...
<title>【${_dict_city.cityName}楼盘|${_dict_city.cityName}房价|${_dict_city.cityName}新房】-搜狐焦点爬房团</title>
...
<body>
		...
		<section class="section1">
			<ul>
				<li>
					<div class="icon1 h1">${sendDate} 爬房团</div>
				</li>
				<li>
		...
		<div class="h1">${sendDate} ${lineInfo.title}</div> 
			<p class="it_ok2">请正确填写个人信息，以便我们与您取得联系，进行爬房团相关确认。</p>
