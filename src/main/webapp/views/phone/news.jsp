...
<body class="wap_hotquestion_all wap_baodian_info_all">
	<div class="wap_container">
		...
		<!-- 面包屑 -->
		<div class="link_boxs"><a href="${ctx }/${_city.cityPinyinAbbr }/">新房</a><span class="h_space1">></span><a href="${ctx }/${_city.cityPinyinAbbr }/xinwen/">房产新闻</a><span class="h_space1">></span>房产新闻正文</div>
