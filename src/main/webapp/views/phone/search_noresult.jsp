	...
	<div class="wap_container">
		...
		<header class="top_nav">
			...
			<ul class="nav_box_ul1 main_menu_ul1">
				<li><a href="${ctx }/${_city.cityPinyinAbbr }/loupan/" role="text" url="" role-current="current">楼盘</a></li>
		...
		<section class="search_main">
			...
			<section class="wap_module search_module" data-title="搜索框-模块">
				...
				<div class="search_no_result">
					<span class="search_no_result_icon">没有找到符合<h1><em class="red1">${group_name }</em>的楼盘</h1><br />请修改条件重新搜索</span>
				</div>
			...
			<div class="foot_nav_box2">
				...
				<ul class="nav_box_ul1 wap_version_menu_ul1">
					<c:if test="${mobile=='false'}">
						<li><a href="#" role="wap_search_version_text" url="" data-nr="PAD">Pad版</a></li>
					</c:if>
